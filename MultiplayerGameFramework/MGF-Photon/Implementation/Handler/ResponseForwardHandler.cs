...
namespace MGF_Photon.Implementation.Handler
{
    public class ResponseForwardHandler : ServerHandler, IDefaultResponseHandler<IServerPeer>
    {
        ...
        public ResponseForwardHandler(ILogger log, IConnectionCollection<IClientPeer> connectionCollection,
        ...
        // maybe shouldnt be protected but think this is due to photon4
