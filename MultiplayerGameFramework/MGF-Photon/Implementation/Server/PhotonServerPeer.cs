...
namespace MGF_Photon.Implementation.Server
{
    public class PhotonServerPeer : ServerPeerBase, IServerPeer
    {
        ...
        protected override void OnOperationRequest(OperationResponse operationResponse, SendParameters sendParameters)
        {
        ...
        public void SendMessage(IMessage message)
        {
            ...
            if (response != null)
            {
                SendOperationResponse(new OperationResponse(message.Code, message.Parameters)
                {
