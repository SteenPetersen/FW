...
namespace MGF.Photon.Implementation.Server
{
    public class OutboundPhotonPeer : OutboundS2SPeer
    {
        ...
        public void ReconnectToPeer()
        {
            ...
            {
                var timer = new Timer(o => ConnectTcp(_peerInfo.MasterEndPoint, _peerInfo.ApplicationName,
                    TypeCache.SerializePeerInfo(_peerInfo)), null, _peerInfo.ConnectRetryIntervalSeconds * 1000, 0);
            }
        }
